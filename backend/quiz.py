...
def add_quiz():
    ...
    for question in questions:
        ...
        add_question_endpoint = f"http://172.31.17.239:5005/add_question"
...
def edit_quiz():
    ...
    for question in questions:
        ...
        edit_question_endpoint = f"http://172.31.17.239:5005/update_question"
...
def delete_quiz(quizId):
    ...
    delete_questions_endpoint = f"http://172.31.17.239:5005/delete_questions/{quizId}"
    response = requests.delete(delete_questions_endpoint)

    # Clear all users saved_quizzes that have the quiz_id
    clear_saved_quizzes_endpoint = f"http://172.31.17.239:5002/clear_deleted_quiz"
    payload = {
        "quizId": quizId
    }
    ...
    delete_quiz_sessions_endpoint = f"http://172.31.17.239:5006/delete_quiz_sessions/{quizId}"
...
def get_daily_quiz():
    ...
    endpoint = f"http://172.31.17.239:5005/get_quiz_questions/{quiz_id}"
...
def new_quiz_session():
    ...
    quiz_questions_endpoint = f"http://172.31.17.239:5005/get_quiz_questions/{quiz_id}"
    ...
    session_creation_endpoint = f"http://172.31.17.239:5006/add_quiz_session"
    session_payload = {
        "user_id": user_id,
        "quiz_id": quiz_id,
    ...
    # Send quizXP to 172.31.17.239:5002/update_quiz_xp/<userId> with total_xp as the payload
    endpoint = f"http://172.31.17.239:5002/update_quiz_xp/{user_id}"
    payload = {
        "quizXP": session_xp
    }
...
def get_recommended_quizzes(userId):
    ...
    quiz_sessions_endpoint = f"http://172.31.17.239:5006/get_user_quiz_sessions/{userId}"
