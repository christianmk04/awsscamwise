  ...
  const handleSave = async () => {
    ...
    try {
      if (fieldToEdit === "fullName") {
        // Update full name
        const response = await fetch("http://18.214.76.26:5002/update_full_name", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        // Update bio
        const response = await fetch("http://18.214.76.26:5002/update_bio", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        const response = await fetch("http://18.214.76.26:5002/update_profile_picture", {
          method: "POST",
