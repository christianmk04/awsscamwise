...
const QMCommunityQuizzes = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Fetch quiz data
        const quizResponse = await fetch('http://18.214.76.26:5004/get_user_quizzes_details');
        if (!quizResponse.ok) {
        ...
        const recommendedResponse = await fetch(`http://18.214.76.26:5004/get_recommended_quizzes_community/${userId}`);
