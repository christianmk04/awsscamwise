...
const QMCustomPractice = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Fetch quiz data
        const quizResponse = await fetch('http://172.31.35.32:5004/get_custom_quizzes_details');
        if (!quizResponse.ok) {
        ...
        const recommendedResponse = await fetch(`http://172.31.35.32:5004/get_recommended_quizzes_custom/${userId}`);
