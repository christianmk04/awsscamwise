...
const QMCustomPractice = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Fetch quiz data
        const quizResponse = await fetch('http://172.31.17.239:5004/get_custom_quizzes_details');
        if (!quizResponse.ok) {
        ...
        const recommendedResponse = await fetch(`http://172.31.17.239:5004/get_recommended_quizzes_custom/${userId}`);
  ...
  const handleDeleteQuiz = async (quizId) => {
    try {
      ...
      // If you're using any other state that might contain the deleted quiz, update it here
    } catch (error) {
          ...
          <Row className="g-0">
            <Col lg={7} className="p-4 p-lg-5">
              <div className="hero-text">
                <h1 className="display-5 fw-bold mb-3">Custom Practice</h1>
                <p className="fs-5 opacity-90 mb-0">
                  Enhance your scam detection skills by selecting specific topics and answering 
                  targeted questions from our extensive question bank.
                </p>
              </div>
            </Col>
            <Col lg={5} className="position-relative">
              ...
              <DotLottieReact
                src="https://lottie.host/9d776cf4-6448-466c-ba7a-573de10efa46/nT2TnJ67QO.lottie"
                loop
                autoplay
...
export default QMCustomPractice;