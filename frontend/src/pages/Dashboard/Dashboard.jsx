  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        ...
        const progressResponse = await fetch('http://0.0.0.0:5008/get_progress', {
          method: 'POST',
          headers: {
        ...
        const badgesResponse = await fetch('http://0.0.0.0:5008/get_badges', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
        ...
        const allQuizResponse = await fetch('http://0.0.0.0:5004/get_custom_quizzes_details');
        ...
        const userSessionsResponse = await fetch('http://0.0.0.0:5006/get_user_quiz_sessions/' + userId);
      ...
      const emailDataResponse = await fetch('http://0.0.0.0:5015/get_email_records/' + userId);
